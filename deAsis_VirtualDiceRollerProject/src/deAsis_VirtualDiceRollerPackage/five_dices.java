...
public class five_dices extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    five_dices frame = new five_dices();
...
//Dice Labels-------------------------------------------------------------------
    public five_dices() {
        ...
        dice5Label.setBounds(93, 249, 100, 100);
...
//Roll Button ---------------------------------------------------------------------    
        ...
        rollButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int totalScore = dice1Face + dice2Face + dice3Face + dice4Face + dice5Face; // Calculate total score
