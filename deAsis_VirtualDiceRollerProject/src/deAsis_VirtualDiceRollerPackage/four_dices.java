...
public class four_dices extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    four_dices frame = new four_dices();
...
//Roll Button ---------------------------------------------------------------------    
        ...
        rollButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int totalScore = dice1Face + dice2Face + dice3Face + dice4Face; // Calculate total score
