...
public class six_dices extends JFrame {
...
//Dice Labels-------------------------------------------------------------------
    public six_dices() {
        ...
        dice1Label.setBounds(36, 27, 100, 100);
        contentPane.add(dice1Label);

        JLabel dice2Label = new JLabel("");
        dice2Label.setBounds(148, 27, 100, 100);
        contentPane.add(dice2Label);

        JLabel dice3Label = new JLabel("");
        dice3Label.setBounds(36, 138, 100, 100);
        contentPane.add(dice3Label);

        JLabel dice4Label = new JLabel("");
        dice4Label.setBounds(148, 138, 100, 100);
        contentPane.add(dice4Label);

        JLabel dice5Label = new JLabel("");
        dice5Label.setBounds(36, 249, 100, 100);
        contentPane.add(dice5Label);

        JLabel dice6Label = new JLabel("");
        dice6Label.setBounds(148, 249, 100, 100);
        contentPane.add(dice6Label);
//
//
//
//
...
//Roll Button ---------------------------------------------------------------------    
        ...
        rollButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int dice3Face = new Random().nextInt(6)+1;
                int dice4Face = new Random().nextInt(6)+1;
                int dice5Face = new Random().nextInt(6)+1;
                int dice6Face = new Random().nextInt(6)+1;
                ...
                dice3Label.setIcon(new ImageIcon(dice3Face + ".png"));
                dice4Label.setIcon(new ImageIcon(dice4Face + ".png"));
                dice5Label.setIcon(new ImageIcon(dice5Face + ".png"));
                dice6Label.setIcon(new ImageIcon(dice6Face + ".png"));

                int totalScore = dice1Face + dice2Face + dice3Face + dice4Face + dice5Face + dice6Face; // Calculate total score
