...
public class three_dices extends JFrame {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    three_dices frame = new three_dices();
...
//Dice Labels-------------------------------------------------------------------
    public three_dices() {
        ...
        dice3Label.setBounds(89, 190, 100, 100);
...
//Roll Button ---------------------------------------------------------------------    
        ...
        rollButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                int totalScore = dice1Face + dice2Face + dice3Face; // Calculate total score
